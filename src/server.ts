...
import {transformPatternMatchVulnerabilitiesToSLMatches, VulnerabilityDetector} from "./patternmatching/vulnerabilitydetector";
...
async function main() {
    ...
    const requestHandlers = {
        ...
        htmlcallgraph: async (req: HTMLCallGraphRequest) => {
            ...
            const vr = (options.vulnerabilities || options.vulnerabilitiesJSON) && vulnerabilityDetector?.collectAllVulnerabilityResults(solver, typer) || {};
